...
use FormateurBundle\Entity\Formateur;
...
class FormateurController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $formateurs = $em->getRepository('FormateurBundle:Formateur')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('FormateurBundle\Form\FormateurType', $formateur);
    ...
    {
        $deleteForm = $this->createDeleteForm($formateur);
        $editForm = $this->createForm('FormateurBundle\Form\FormateurType', $formateur);
