...
use EmploiBundle\Entity\Emploi;
...
class EmploiController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $emplois = $em->getRepository('EmploiBundle:Emploi')->findAll();
    ...
    {
        $emploi = new Emploi();
        $form = $this->createForm('EmploiBundle\Form\EmploiType', $emploi);
    ...
    {
        $deleteForm = $this->createDeleteForm($emploi);
        $editForm = $this->createForm('EmploiBundle\Form\EmploiType', $emploi);
